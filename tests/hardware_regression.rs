...
//!   us-central1-a, Linux 6.17, stage 0 via `cvm build`, stage 1
//!   via `cvm run` chaining stage 0.
...
//!   `cvm enclave`), AL2023 parent, debug-mode enclave. No
...
use cvm_agent::quote::{verify::verify_platform_quote, Platform};
use std::fs;
...
/// is the first time cvm was built inside a TEE *as a CI step
