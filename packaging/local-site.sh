...
usage() {
  cat <<'USAGE'
Usage: packaging/local-site.sh [options] [-- extra llm-event-service args]
...
Examples:
  ...
  packaging/local-site.sh --mode plain --listen 127.0.0.1:8099
  packaging/local-site.sh --mode tee --public-base-url https://events.example
USAGE
}
